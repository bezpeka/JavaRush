 ...
 *    Ctrl + R	            Замена / например, с пмощью этой комбинаци меняем названия переменных
 ...
 * Ctrl + Shift + /	        Многострочный комментарий / убрать комментарий
 ...
 * Shift + F6	            Переименование всех переменных сразу
